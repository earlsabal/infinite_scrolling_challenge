module PinsHelper
	...
	# Used to generate the pins with an integer param for page number
	...
	# Resets list to beginning once last page is reached
	# Will load remaining pins + the first 5 pins once this happens
